package com.zyx.xterm.websocket.handler.remote;

import com.zyx.xterm.websocket.Server;
import com.zyx.xterm.websocket.SshClient;
...
public class SshShellHandler extends TextWebSocketHandler {
	...
	public void afterConnectionEstablished(WebSocketSession session) throws Exception {
		...
		//配置服务器信息
		Server server = new Server("192.168.100.10","root","yellowcong");
